...
/**
 * Страница "Next Generation" (Следующее поколение).
 * 
 * Назначение:
 * Представляет молодежное объединение виноделов "next Generation".
 * Содержит три информационных блока (Wer, Was, Wo) с чередующимся расположением текста и изображений.
 * 
 * Основные зависимости:
 * - Framer Motion: Для анимации появления секций при скролле.
 * - useTranslation: Для многоязычности.
 * 
 * Особенности:
 * - Чередующийся макет (Text-Image / Image-Text).
 * - Адаптивность: На мобильных устройствах всегда порядок Image -> Text (или Text -> Image в зависимости от дизайна), 
 *   но обычно на мобильных контент идет вертикально в естественном порядке.
 *   Здесь используем flex-col-reverse для мобильных, чтобы картинка была над текстом, или наоборот.
 */
